...
def test_estSatisfait():
    ...
    with mock.patch("src.Model.Individu.Individu.getVoisins", return_value=[1, 1]), \
         mock.patch("src.Model.Individu.Individu.getVoisinsMemeGroupe", return_value=[]):
        assert not individu.estSatisfait({})
    with mock.patch("src.Model.Individu.Individu.getVoisins", return_value=[1, 1]), \
         mock.patch("src.Model.Individu.Individu.getVoisinsMemeGroupe", return_value=[1]):
    ...
    with mock.patch("src.Model.Individu.Individu.getVoisins", return_value=[1, 1, 1]), \
         mock.patch("src.Model.Individu.Individu.getVoisinsMemeGroupz", return_value=[]):
        assert not individu.estSatisfait({})
    with mock.patch("src.Model.Individu.Individu.getVoisins", return_value=[1, 1, 1]), \
         mock.patch("src.Model.Individu.Individu.getVoisinsMemeGroupe", return_value=[1, 1]):
        assert individu.estSatisfait({})
    ...
    with mock.patch("src.Model.Individu.Individu.getVoisins", return_value=[1, 1, 1, 1, 1, 1]), \
        ...
        assert not individu.estSatisfait({})
    with mock.patch("src.Model.Individu.Individu.getVoisins", return_value=[1, 1, 1, 1, 1, 1]), \
         mock.patch("src.Model.Individu.Individu.getVoisinsMemeGroupe", return_value=[1, 1, 1]):
        assert individu.estSatisfait({})
